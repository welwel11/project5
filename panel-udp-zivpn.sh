...
# SERVICE CONTROL
# ==============================
start_service(){ systemctl start zivpn.service; }
stop_service(){ systemctl stop zivpn.service; }
restart_service(){ systemctl restart zivpn.service; }
